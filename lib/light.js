...
var HueLight = module.exports = function HueLight(def) {
	...
	// this.t1 = setTimeout(function() {
		// console.log("HueLight: turning on");
		// self.getFacet("binaryIn").handleMessage({value: true});
	// }, 5000);
// 	
	// this.t2 = setTimeout(function() {
		// console.log("HueLight: turning off");
		// self.getFacet("binaryIn").handleMessage({value: false});
	// }, 7000);
};
